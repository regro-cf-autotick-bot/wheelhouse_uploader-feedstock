...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wheelhouse_uploader-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15338&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wheelhouse_uploader-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wheelhouse_uploader` can be installed with:

```
conda install wheelhouse_uploader
```

It is possible to list all of the versions of `wheelhouse_uploader` available on your platform with:
